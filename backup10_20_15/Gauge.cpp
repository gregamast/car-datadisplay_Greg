...
void Gauge::setNumRanges(int nr){
	numRanges = nr;
...
void Gauge::update(float needleValue){
	...
	void Gauge::drawNeedle(void)
{
	...
	float value = 0;
	if(value>=0) angle = (180/30)*value;
	else angle = (90/30)*2.036*value;

	float needleLength = 0.7*radius;
